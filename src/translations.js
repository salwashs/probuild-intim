...
export const translations = {
  ...
  bookingForm: {
    id: {
      ...
      ctaSub: 'Pilih jenis pendaftaran Anda di bawah ini.',
    ...
    en: {
      ...
      ctaSub: 'Choose your registration type below.',
  ...
  // -----------------------------------------------
  // VISITOR REGISTRATION / RSVP
  // -----------------------------------------------
  visitorRegistration: {
    id: {
      heroTitle: 'Konfirmasi Kehadiran',
      heroSubtitle: 'Undangan Resmi ProBuild INTIM 2026',
      section1Title: 'Informasi Acara',
      themeLabel: 'Tema',
      ...
      section2Title: 'Data Diri Tamu',
      section2Sub: 'Lengkapi data berikut untuk keperluan protokol, keamanan, dan daftar hadir.',
      section3Title: 'Konfirmasi Kehadiran',
      section4Title: 'Peran & Kebutuhan Khusus',
      section5Title: 'Informasi Penting untuk Tamu',
      section6Title: 'Kirim Konfirmasi',
      fields: {
        fullName: 'Nama Lengkap beserta gelar',
        fullNamePlaceholder: 'Contoh: Ir. Budi Santoso, M.T.',
        position: 'Jabatan',
        positionPlaceholder: 'Jabatan Anda',
        institution: 'Instansi / Perusahaan',
        institutionPlaceholder: 'Nama lembaga atau perusahaan',
        institutionAddress: 'Alamat Instansi',
        institutionAddressPlaceholder: 'Kota & provinsi',
        identityNumber: 'Nomor Identitas (KTP)',
        identityNumberPlaceholder: '16 digit nomor KTP',
        whatsapp: 'Nomor WhatsApp',
        whatsappPlaceholder: '081234567890',
        email: 'Email',
        emailPlaceholder: 'email@instansi.com',
        partySize: 'Jumlah Rombongan',
        partySizePlaceholder: '— Pilih jumlah —',
        partySizeHint: 'Maksimal termasuk diri sendiri',
        groupMemberName: 'Nama anggota',
        groupMemberPosition: 'Jabatan anggota',
        delegateName: 'Nama Perwakilan',
        delegateNamePlaceholder: 'Nama lengkap perwakilan resmi',
        delegatePosition: 'Jabatan Perwakilan',
        delegatePositionPlaceholder: 'Jabatan perwakilan',
        eventRolesOther: 'Keterangan peran lainnya',
        eventRolesOtherPlaceholder: 'Jelaskan peran Anda',
        notes: 'Catatan / pesan untuk panitia',
        notesPlaceholder: 'Kebutuhan atau informasi tambahan (opsional)',
      },
      attendance: {
        hadir: 'Hadir — akan menghadiri acara sesuai jadwal',
        diwakilkan: 'Diwakilkan — berhalang hadir namun menugaskan perwakilan resmi',
        berhalangan: 'Berhalangan hadir — tidak dapat hadir',
      },
      eventRoles: {
      ...
      importantInfo: [
        'Konfirmasi paling lambat: Jum\'at, 19 September 2026',
        'Pintu masuk melalui Pintu Utama — tunjukkan bukti konfirmasi + KTP di registrasi desk official ProBuild INTIM 2026',
        'Parkir: disediakan area khusus tamu undangan',
        'Pakaian: resmi / sopan (Batik / Seragam Dinas / Jas)',
        'Bukti konfirmasi akan dikirim ke email/WhatsApp setelah data tercatat — harap ditunjukkan saat kedatangan',
      ],
      termsLabel:
        'Saya menyatakan data di atas benar dan bersedia mematuhi ketentuan acara ProBuild INTIM 2026',
      submit: 'Kirim Konfirmasi Kehadiran',
      loading: 'Mengirim...',
      ...
      errors: {
        ...
        partySize: 'Pilih jumlah rombongan',
        attendance: 'Pilih konfirmasi kehadiran',
        eventRoles: 'Pilih minimal satu peran',
        specialNeeds: 'Pilih minimal satu kebutuhan khusus',
        eventRolesOther: 'Jelaskan peran lainnya',
    ...
    en: {
      heroTitle: 'Attendance Confirmation',
      heroSubtitle: 'Official Invitation — ProBuild INTIM 2026',
      section1Title: 'Event Information',
      themeLabel: 'Theme',
      dateLabel: 'Date',
      timeLabel: 'Time',
      venueLabel: 'Venue',
      ...
      section2Title: 'Guest Information',
      section2Sub: 'Please complete the following for protocol, security, and attendance records.',
      section3Title: 'Attendance Confirmation',
      section4Title: 'Role & Special Requirements',
      section5Title: 'Important Information for Guests',
      section6Title: 'Submit Confirmation',
      fields: {
        fullName: 'Full name with title',
        fullNamePlaceholder: 'e.g. Ir. Budi Santoso, M.T.',
        position: 'Position',
        positionPlaceholder: 'Your position',
        institution: 'Institution / Company',
        institutionPlaceholder: 'Organization or company name',
        institutionAddress: 'Institution Address',
        institutionAddressPlaceholder: 'City & province',
        identityNumber: 'ID Number (KTP)',
        identityNumberPlaceholder: '16-digit KTP number',
        ...
        partySizeHint: 'Including yourself',
        groupMemberName: 'Member name',
        groupMemberPosition: 'Member position',
        delegateName: 'Representative Name',
        delegateNamePlaceholder: 'Full name of official representative',
        delegatePosition: 'Representative Position',
        delegatePositionPlaceholder: 'Representative position',
        eventRolesOther: 'Other role description',
        eventRolesOtherPlaceholder: 'Describe your role',
        notes: 'Notes / message for committee',
        notesPlaceholder: 'Additional requirements or information (optional)',
      },
      attendance: {
        hadir: 'Attending — will attend as scheduled',
        diwakilkan: 'Represented — unable to attend but sending official representative',
        berhalangan: 'Unable to attend',
      },
      eventRoles: {
        pembuka_sambutan: 'Opening Remarks',
        narasumber: 'Speaker',
        peninjau_stand: 'Booth Reviewer',
        tamu_undangan: 'Invited Guest',
        lainnya: 'Other',
      },
      specialNeeds: {
        kursi_roda: 'Wheelchair',
        akses_prioritas: 'Priority access',
        meja_khusus: 'Special seating',
        penerjemah: 'Interpreter',
        tidak_ada: 'None',
      },
      importantInfo: [
        'Confirmation deadline: Friday, 19 September 2026',
        'Entry via Main Gate — show confirmation proof + ID at official ProBuild INTIM 2026 registration desk',
        'Parking: dedicated area for invited guests',
        'Dress code: formal / neat (Batik / uniform / suit)',
        'Confirmation proof will be sent to email/WhatsApp after submission — please show upon arrival',
      ],
      termsLabel:
        'I declare the above information is correct and agree to comply with ProBuild INTIM 2026 event terms',
      submit: 'Submit Attendance Confirmation',
      loading: 'Submitting...',
      ...
      errors: {
        ...
        ktpInvalid: 'KTP number must be 16 digits',
        whatsappInvalid: 'Invalid WhatsApp number',
        partySize: 'Select group size',
        attendance: 'Select attendance confirmation',
        eventRoles: 'Select at least one role',
        specialNeeds: 'Select at least one special need',
        eventRolesOther: 'Describe other role',
  ...
  footer: {
    id: {
      ...
      quickLinks: [
        ...
        { label: 'Registrasi Pengunjung', href: '/registrasi' },
    ...
    en: {
      ...
      quickLinks: [
        ...
        { label: 'Visitor Registration', href: '/registrasi' },
