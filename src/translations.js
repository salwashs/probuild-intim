...
export const translations = {
  ...
  visitorRegistration: {
    id: {
      heroTitle: 'Registrasi Visitor',
      heroSubtitle: 'ProBuild INTIM 2026',
      ...
      section2Title: 'Data Visitor',
      section2Sub: 'Lengkapi data berikut untuk pendaftaran pengunjung ProBuild INTIM 2026.',
      section5Title: 'Informasi Penting',
      section6Title: 'Kirim Pendaftaran',
      fields: {
        email: 'Email',
        ...
        institutionType: 'Asal visitor',
        institution: 'Nama perusahaan / instansi',
        institutionPlaceholder: 'Nama perusahaan atau instansi',
        domisili: 'Domisili',
        domisiliPlaceholder: 'Kota / kabupaten tempat tinggal',
        position: 'Jabatan',
        positionPlaceholder: 'Jabatan Anda (opsional)',
        optional: '(opsional)',
      },
      institutionTypes: {
        instansi: 'Dari perusahaan / instansi',
        umum: 'Visitor umum (bukan dari instansi)',
      },
      importantInfo: [
        'Simpan nomor registrasi dan QR code setelah berhasil mendaftar',
        'Tunjukkan QR code di meja check-in saat kedatangan',
        'Satu email / WhatsApp hanya dapat digunakan untuk satu pendaftaran',
      ...
      errors: {
        ...
        whatsappInvalid: 'Nomor WhatsApp tidak valid (8–16 digit)',
        institutionType: 'Pilih asal visitor',
        terms: 'Anda harus menyetujui ketentuan acara',
        minLength: 'Minimal {min} karakter',
        conflict: 'Email atau WhatsApp ini sudah terdaftar untuk event ini.',
        eventNotFound:
    ...
    en: {
      heroTitle: 'Visitor Registration',
      heroSubtitle: 'ProBuild INTIM 2026',
      ...
      section2Title: 'Visitor Details',
      section2Sub: 'Please complete the following to register as a visitor for ProBuild INTIM 2026.',
      section5Title: 'Important Information',
      section6Title: 'Submit Registration',
      fields: {
        email: 'Email',
        ...
        whatsappPlaceholder: '081234567890',
        institutionType: 'Visitor type',
        institution: 'Company / institution name',
        institutionPlaceholder: 'Company or institution name',
        domisili: 'Domicile',
        domisiliPlaceholder: 'City / regency of residence',
        position: 'Position',
        positionPlaceholder: 'Your position (optional)',
        optional: '(optional)',
      },
      institutionTypes: {
        instansi: 'From a company / institution',
        umum: 'General visitor (not from an institution)',
      },
      importantInfo: [
        'Save your registration number and QR code after successful registration',
        'Show the QR code at the check-in desk upon arrival',
        'Each email / WhatsApp can only be used for one registration',
      ...
      errors: {
        ...
        whatsappInvalid: 'Invalid WhatsApp number (8–16 digits)',
        institutionType: 'Select visitor type',
        terms: 'You must agree to the event terms',
        minLength: 'Minimum {min} characters',
        conflict: 'This email or WhatsApp is already registered for this event.',
        eventNotFound:
