            ...
            <div className={styles.brand}>
              <a href="#" className={styles.logo} onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
                ...
                <span className={styles.logo__text}>
                  <strong>KONSTRUKSI EXPO</strong>
                  <em>2025</em>
                </span>
              </a>

              <p className={styles.brand__desc}>
                Pameran konstruksi dan arsitektur terbesar Indonesia. Platform bertemu, 
                berinovasi, dan bertransaksi bagi seluruh ekosistem industri bangunan.
              </p>

              <div className={styles.socials}>
                {socialLinks.map((s) => (
                  <a key={s.name} href={s.href} className={styles.social} aria-label={s.name} onClick={(e) => e.preventDefault()}>
                    {s.icon}
                  </a>
                ))}
              </div>
              ...
              <div className={styles.badge}>
                ...
                <span>Event Berlangsung: 14–17 November 2025</span>
              </div>
            </div>
            ...
            <div className={styles.col}>
              ...
              <ul className={styles.contacts}>
                <li>
                  ...
                  <span>JIExpo Kemayoran, Jl. Benyamin Sueb, Jakarta Pusat</span>
                </li>
                <li>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
                ...
                <li>
                  ...
                  <a href="mailto:info@konstruksiexpo.id">info@konstruksiexpo.id</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className={styles.bottom}>
        <div className="container">
          <div className={styles.bottom__inner}>
            <p>© 2025 Konstruksi Expo Indonesia. Seluruh hak cipta dilindungi.</p>
            <div className={styles.bottom__links}>
              ...
              <span>·</span>
              <a href="#" onClick={(e) => e.preventDefault()}>Peta Situs</a>
            </div>
          </div>
        </div>
      </div>
